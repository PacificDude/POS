	...
	public Sales() {
		...
		mntmTodaysTotalSales.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				String reportPath = "C:\\Users\\Miguel\\Documents\\Workspace Eclipse\\POS\\src\\reports\\TodaysTopSales.jrxml";
				try {
		...
		mntmDailyTopProducts = new JMenuItem("Daily Top Products");
		mntmDailyTopProducts.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				if (isNumber(inputTopNumber) == true){
					String reportPath = "C:\\Users\\Miguel\\Documents\\Workspace Eclipse\\POS\\src\\reports\\TopProducts.jrxml";
					try {
		...
		JMenuItem mntmWeeklyTopProducts = new JMenuItem("Weekly Top Products");
		mnReports.add(mntmWeeklyTopProducts);
		
		JMenuItem mntmMonthlyTopProducts = new JMenuItem("Monthly Top Products");
		mnReports.add(mntmMonthlyTopProducts);
